...
The data must be analytics ready (like gold mart analytics if you think about medallion architecture), and you need to be available to anseer any questions about the data.
